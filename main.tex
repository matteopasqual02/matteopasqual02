...
\begin{header}
    ...
    \AND
    \kern 0.25 cm
    \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/matteo-pasqual-1b5184333/}{\color{black}{\footnotesize\faLinkedinIn}\hspace*{0.13cm}Matteo Pasqual}}
...
\section{\mbox{{\color{black}\footnotesize\faGraduationCap}\hspace*{0.13cm}Education}}
    ...
    \end{twocolentry}
    \begin{onecolentry}
    B.Sc. in Computer Science and Engineering \hspace{1pt}(\href{https://www.polimi.it/}{polimi.it}) \hspace{80pt}Grade: 109/110
    \end{onecolentry}
...
\section{\mbox{{\color{black}\footnotesize\faWrench}\hspace*{0.13cm}Skills}}
    ...
    \begin{samepage}
    \begin{highlights}
        \item \textbf{Programming \& Software Dev.}: C/C++, Java, Python, Git (GitHub), JML, Alloy
        \item \textbf{Databases Technologies}: SQL, Neo4j, MongoDB, Spark, Zilliz-Milvus
        \item \textbf{OS \& Middelware}: ROS, Linux, Window, Docker and VMs
        \item \textbf{Other Technologies}: Matlab, Docker and VMs, VHDL/Vivado, LateX, MS Office
    \end{highlights}
    \end{samepage}
...
\section{\mbox{{\color{black}\footnotesize\faReact}\hspace*{0.13cm}Projects and Research}}
        ...
        \begin{onecolentry}
                \begin{highlights}
                \item Participated in a national university-level competition in the robotics field \hspace{1pt}(\href{https://www.leonardo.com/it/innovation-technology/open-innovation/drone-contest}{Drone Contest})
                \item Designed and implemented a multi-agent system for collaborative navigation and task execution using ROS2
                \item Developed decentralized decision-making algorithms and inter-drone communication protocols
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
                \begin{highlights}
                \item Presented in a university lecture-like format topics related to Kolmogorov Arnold Networks (\href{https://github.com/matteopasqual02/KAN-naml.git}{Git Hub})
                \item evaluated 30/30 and selected for use in future lectures of the Numerical Analysis for Machine Learning (NAML) course at PoliMi
            \end{highlights}
        \end{onecolentry}
